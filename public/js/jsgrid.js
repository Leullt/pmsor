(function(window, $, undefined) {
  ...
  $($insertRow).appendTo($body);
        ...
        _createInsertRow: function() {
            ...
            var $result = $("<table>").addClass(this.insertRowClass);
            var $result1 = $("<tr>").appendTo($result);
            this._eachField(function(field) {
...
(function(jsGrid, $, undefined) {
    ...
    ControlField.prototype = new Field({
        ...
        deleteButtonClass: "btn-default",
        searchButtonClass: "jsgrid-search-button",
        clearFilterButtonClass: "jsgrid-clear-filter-button",
        insertButtonClass: "jsgrid-insert-button btn-primary",
        updateButtonClass: "btn-light",
